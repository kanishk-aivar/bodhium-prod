    ...
    try:
        ...
        if task_id:
            try:
                ...
                print(f"✅ Updated task status to '{status}' in RDS")
            except Exception as db_error:
                print(f"❌ Failed to update task status to {status}: {db_error}")
                ...
                if citations:
                    ...
                    if citation_urls:
                        ...
                        if citation_invocation_success:
                            ...
                            print(f"🔗 Citation-scraper lambda triggered with {len(unique_citation_urls)} URLs")
                        ...
                        print(f"ℹ️ No valid citation URLs found, skipping citation-scraper invocation")
                else:
        ...
        # Try to update task status to failed or retry
        if task_id:
            try:
